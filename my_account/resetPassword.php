...
<main class="form-signin w-100 m-auto">
    <form action="" method="post">
        <h1 class="h3 mb-3 fw-normal">Resetare parolă</h1>
        <div class="form-floating mb-3">
            <input type="password" class="form-control" id="floatingInput" placeholder="Parola" name="parola"/>
            <label for="floatingInput">Parolă</label>
        </div> <div class="form-floating mb-3">
            <input type="password" class="form-control" id="floatingInput" placeholder="Repeta parola" name="repetaParola"/>
            <label for="floatingInput">Repetă parolă</label>
        </div>
        <button class="btn btn-primary w-100 py-2" type="submit" name="submit" id="btnTrimitereEmail">Confirmă parolă</button>
        <?php
