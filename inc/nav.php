...
<nav class="navbar navbar-expand-md fixed-top navbar-light bg-light border border-2">
    <div class="container-fluid">
        <a class="navbar-brand" href="/index.php">
            <img src="/images/green_audit_logo.png" height="50" alt="">
        </a>
            ...
            <form class="d-flex" role="search">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <?php if (isset($is_logged) && $is_logged) { ?>
                        <?php
                            $logged_user = mysqli_fetch_assoc(mysqli_query($con, "SELECT id, is_admin FROM users WHERE id = " . $_SESSION['audit_logged_in_user_id']));
