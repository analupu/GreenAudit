...
<main class="container">
    <div class="position-relative overflow-hidden m-md-3 text-center bg-body-tertiary" style="background-image: url('/images/nature_backgound.jpg')">
            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasLabel">Categorii</h5>
                    ...
                    <div class="offcanvas-body text-center">
                        <ul class="navbar-nav galerie-categories-buttons mx-auto flex-wrap flex-row justify-content-center">
                            ...
                            while ($row = mysqli_fetch_assoc($categoryQuery)) {
                                ...
                                echo '<li class="nav-item bigger-text"><a class="nav-link" href="#" data-filter="' . $className . '">' . $label . '</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
        ...
        <div class="col-md-6 p-lg-5 mx-auto my-3">
            <h1 class="display-3 fw-bold">Galerie de Imagini</h1>
            <h3 class="fw-normal text-muted mb-3">Explorează imaginile pe categorii</h3>
        </div>
